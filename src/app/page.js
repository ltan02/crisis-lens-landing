      ...
      <header className="fixed top-0 left-0 right-0 z-50 p-4 md:p-6">
        <div className="flex justify-end items-center">
          <a 
            ...
            className="bg-gradient-to-r from-blue-600 to-[#FF6B6B] hover:from-blue-700 hover:to-[#FF5555] text-white px-4 py-2 md:px-6 md:py-2 rounded-full font-medium transition-all duration-300 transform hover:scale-105 flex items-center space-x-2"
          >
            <span>Go</span>
